using BepInEx;
using FerthsArmory.Artifact;
using FerthsArmory.Equipment;
using FerthsArmory.Equipment.EliteEquipment;
using FerthsArmory.Items;
using IL.RoR2;
using R2API;
using R2API.Utils;
using System;
...
namespace FerthsArmory
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("FerthsArmory.ferthsarmoryassets"))
            {
            ...
            var configEntry = InLobbyConfig.Fields.ConfigFieldUtilities.CreateFromBepInExConfigFile(Config, "Ferth's Armoury");
